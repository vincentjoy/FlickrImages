...
class ImageListOutletObject: NSObject {
    ...
    @IBOutlet weak var paginationIndicatorBottom: NSLayoutConstraint! /* At the time of pagination, a message saying "Loading more images.." will appear from the bottom like a flash card and dismiss after the API call finish. */
}
